...
FROM traefik:v2.5.5
FROM squidfunk/mkdocs-material:8.1.0
...
FROM ghost:4.27.2
FROM bitnami/ghost:4.24.0-debian-10-r0
FROM matomo:4.6.2-apache
FROM nocodb/nocodb:0.83.5
...
FROM bitnami/minio:2021.11.9-debian-10-r8
FROM bitnami/minio-client:2021.12.10-debian-10-r0
...
FROM bitnami/grafana:8.3.2-debian-10-r2
