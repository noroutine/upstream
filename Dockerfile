...
FROM gitlab/gitlab-runner:alpine-v14.9.0
# gitlab/gitlab-runner
# gitlab/gitlab-ce
FROM gitlab/gitlab-ce:14.8.4-ce.0
# gitlab/gitlab-ce
...
# ghost
# bitnami/ghost
FROM bitnami/ghost:4.41.0-debian-10-r0
# bitnami/ghost
# matomo
...
# bitnami/nginx
# bitnami/minio
FROM bitnami/minio:2022.3.22-debian-10-r0
# bitnami/minio
