...
FROM jupyterhub/k8s-secret-sync:1.1.4
...
FROM ghost:4.21.0
FROM bitnami/ghost:4.21.0-debian-10-r2
FROM matomo:4.5.0-apache
FROM nocodb/nocodb:0.80.0
...
FROM bitnami/nginx-ingress-controller:0.49.3-debian-10-r30
FROM bitnami/nginx:1.21.3-debian-10-r38
FROM bitnami/minio:2021.6.17-debian-10-r50
FROM bitnami/minio-client:2021.10.7-debian-10-r20
...
FROM registry.gitlab.com/gitlab-org/cluster-integration/auto-build-image:v1.4.1
