...
FROM gitlab/gitlab-runner:alpine-v14.3.0
...
FROM yandex/clickhouse-server:21.9.4.35-alpine
...
FROM bitnami/grafana:8.1.5-debian-10-r7
...
FROM registry.gitlab.com/gitlab-org/cluster-integration/auto-deploy-image:v2.13.0
...
FROM summerwind/actions-runner-controller:v0.20.2-fccf299
