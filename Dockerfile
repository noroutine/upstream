...
# logstash/logstash
FROM docker.elastic.co/logstash/logstash:8.3.0
# logstash/logstash
...
FROM gitlab/gitlab-runner:alpine-v15.1.0
# gitlab/gitlab-runner
...
# verdaccio/verdaccio
FROM verdaccio/verdaccio:5.13.1
# verdaccio/verdaccio
...
# bitnami/minio
FROM bitnami/minio:2022.6.25-debian-11-r0
# bitnami/minio
