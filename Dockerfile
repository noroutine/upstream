...
# kibana/kibana
FROM docker.elastic.co/kibana/kibana:8.3.2
# kibana/kibana
...
FROM registry.gitlab.com/gitlab-org/cluster-integration/auto-deploy-image:v2.31.0
# gitlab-org/cluster-integration/auto-deploy-image
...
FROM summerwind/actions-runner-controller:v0.25.2-6762c5c
# summerwind/actions-runner-controller
...
# bitnami/nginx
FROM bitnami/nginx:1.22.0-debian-11-r6
# bitnami/nginx
...
# bitnami/consul
FROM bitnami/consul:1.12.2-debian-11-r6
# bitnami/consul
...
# calico/typha
FROM calico/typha:v3.23.2
# calico/typha

# calico/ctl
FROM calico/ctl:v3.23.2
# calico/ctl

# calico/node
FROM calico/node:v3.23.2
# calico/node

# calico/cni
FROM calico/cni:v3.23.2
# calico/cni

# calico/apiserver
FROM calico/apiserver:v3.23.2
# calico/apiserver

# calico/kube-controllers
FROM calico/kube-controllers:v3.23.2
# calico/kube-controllers

# calico/dikastes
FROM calico/dikastes:v3.23.2
# calico/dikastes

# calico/pod2daemon-flexvol
FROM calico/pod2daemon-flexvol:v3.23.2
# calico/pod2daemon-flexvol
