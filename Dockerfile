...
# plausible/analytics
# verdaccio/verdaccio
FROM verdaccio/verdaccio:5.7.1
# verdaccio/verdaccio
# strapi/strapi
...
FROM jupyter/datascience-notebook:hub-2.2.1
# jupyter/datascience-notebook
...
FROM registry.gitlab.com/gitlab-org/cluster-integration/auto-deploy-image:v2.22.0
# gitlab-org/cluster-integration/auto-deploy-image
# vaultwarden/server
