...
# logstash/logstash
# kibana/kibana
FROM docker.elastic.co/kibana/kibana:8.1.3
# kibana/kibana
# alerta/alerta-web
...
# plausible/analytics
# verdaccio/verdaccio
FROM verdaccio/verdaccio:5.9.0
# verdaccio/verdaccio
# strapi/strapi
...
# ghost
# bitnami/ghost
FROM bitnami/ghost:4.46.0-debian-10-r0
# bitnami/ghost
# matomo
FROM matomo:4.9.1-apache
# matomo
# nocodb/nocodb
FROM nocodb/nocodb:0.90.8
# nocodb/nocodb
# docker
...
# bitnami/nginx
# bitnami/minio
FROM bitnami/minio:2022.4.16-debian-10-r0
# bitnami/minio
...
# bitnami/metallb-speaker
# bitnami/grafana
FROM bitnami/grafana:8.4.5-debian-10-r9
# bitnami/grafana
# bitnami/consul
FROM bitnami/consul:1.11.4-debian-10-r38
# bitnami/consul
# bitnami/nats
FROM bitnami/nats:2.7.4-debian-10-r29
# bitnami/nats
...
FROM bitnami/kubeapps-asset-syncer:2.4.4-scratch-r1
# bitnami/kubeapps-asset-syncer
