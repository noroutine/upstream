...
FROM registry.gitlab.com/gitlab-org/cluster-integration/gitlab-agent/agentk:v16.7.0
# gitlab-org/cluster-integration/gitlab-agent/agentk
...
FROM bitnami/minio-client:2023.12.29-debian-11-r0
# bitnami/minio-client
...
# syncthing/syncthing
FROM syncthing/syncthing:1.27.1
# syncthing/syncthing
...
FROM confluentinc/cp-enterprise-control-center:7.5.3
# confluentinc/cp-enterprise-control-center

# confluentinc/cp-enterprise-replicator
FROM confluentinc/cp-enterprise-replicator:7.5.3
# confluentinc/cp-enterprise-replicator

# confluentinc/cp-kafka-rest
FROM confluentinc/cp-kafka-rest:7.5.3
# confluentinc/cp-kafka-rest

# confluentinc/cp-ksqldb-server
FROM confluentinc/cp-ksqldb-server:7.5.3
# confluentinc/cp-ksqldb-server

# confluentinc/cp-ksqldb-cli
FROM confluentinc/cp-ksqldb-cli:7.5.3
# confluentinc/cp-ksqldb-cli

# confluentinc/cp-schema-registry
FROM confluentinc/cp-schema-registry:7.5.3
# confluentinc/cp-schema-registry

# confluentinc/cp-server
FROM confluentinc/cp-server:7.5.3
# confluentinc/cp-server

# confluentinc/cp-server-connect
FROM confluentinc/cp-server-connect:7.5.3
# confluentinc/cp-server-connect
