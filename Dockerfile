...
# ghost
# bitnami/ghost
FROM bitnami/ghost:4.36.0-debian-10-r0
# bitnami/ghost
# matomo
FROM matomo:4.7.1-apache
# matomo
# nocodb/nocodb
FROM nocodb/nocodb:0.84.10
# nocodb/nocodb
# docker
...
# bitnami/nginx
# bitnami/minio
FROM bitnami/minio:2022.2.12-debian-10-r0
# bitnami/minio
# bitnami/minio-client
FROM bitnami/minio-client:2022.2.16-debian-10-r0
# bitnami/minio-client
...
# paulbouwer/hello-kubernetes
# stakater/reloader
FROM stakater/reloader:v0.0.105
# stakater/reloader
# registry
FROM registry:2.8.0
# registry
...
FROM registry.gitlab.com/gitlab-org/cluster-integration/auto-deploy-image:v2.21.0
# gitlab-org/cluster-integration/auto-deploy-image
# vaultwarden/server
FROM vaultwarden/server:1.24.0
# vaultwarden/server
# mailu/dovecot
FROM mailu/dovecot:1.9.14
# mailu/dovecot
# mailu/rspamd
FROM mailu/rspamd:1.9.14
# mailu/rspamd
# mailu/admin
FROM mailu/admin:1.9.14
# mailu/admin
# mailu/nginx
FROM mailu/nginx:1.9.14
# mailu/nginx
# mailu/clamav
FROM mailu/clamav:1.9.14
# mailu/clamav
# mailu/postfix
