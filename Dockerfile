...
FROM quay.io/prometheus/alertmanager:v0.34.1
# quay.io/prometheus/alertmanager
...
FROM registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.20.0
# registry.k8s.io/kube-state-metrics/kube-state-metrics
...
FROM percona/mongodb_exporter:0.53.0
# percona/mongodb_exporter
...
FROM haproxytech/kubernetes-ingress:3.2.15
# haproxytech/kubernetes-ingress
...
FROM registry.k8s.io/csi-secrets-store/driver:v1.6.1
# registry.k8s.io/csi-secrets-store/driver

# registry.k8s.io/csi-secrets-store/driver-crds
FROM registry.k8s.io/csi-secrets-store/driver-crds:v1.6.1
# registry.k8s.io/csi-secrets-store/driver-crds

# stakater/reloader
FROM stakater/reloader:v1.4.22
# stakater/reloader
...
FROM natsio/prometheus-nats-exporter:0.20.2
# natsio/prometheus-nats-exporter

# natsio/nats-server-config-reloader
FROM natsio/nats-server-config-reloader:0.24.0
# natsio/nats-server-config-reloader
...
FROM azul/zulu-openjdk-debian:26.0.2.1-26.32
# azul/zulu-openjdk-debian
...
# syncthing/syncthing
FROM syncthing/syncthing:2.1.5
# syncthing/syncthing

# syncthing/discosrv
FROM syncthing/discosrv:2.1.5
# syncthing/discosrv

# syncthing/relaysrv
FROM syncthing/relaysrv:2.1.5
# syncthing/relaysrv
...
FROM quay.io/jetstack/cert-manager-controller:v1.21.2
# quay.io/jetstack/cert-manager-controller

# quay.io/jetstack/cert-manager-cainjector
FROM quay.io/jetstack/cert-manager-cainjector:v1.21.2
# quay.io/jetstack/cert-manager-cainjector

# quay.io/jetstack/cert-manager-webhook
FROM quay.io/jetstack/cert-manager-webhook:v1.21.2
# quay.io/jetstack/cert-manager-webhook
...
FROM openbao/openbao-csi-provider:2.0.3
# openbao/openbao-csi-provider
...
# registry.k8s.io/kube-apiserver
FROM registry.k8s.io/kube-apiserver:v1.36.4
# registry.k8s.io/kube-apiserver

# registry.k8s.io/kube-proxy
FROM registry.k8s.io/kube-proxy:v1.36.4
# registry.k8s.io/kube-proxy

# registry.k8s.io/kube-scheduler
FROM registry.k8s.io/kube-scheduler:v1.36.4
# registry.k8s.io/kube-scheduler
...
# registry.k8s.io/kube-apiserver
FROM registry.k8s.io/kube-apiserver:v1.35.8
# registry.k8s.io/kube-apiserver

# registry.k8s.io/kube-proxy
FROM registry.k8s.io/kube-proxy:v1.35.8
# registry.k8s.io/kube-proxy

# registry.k8s.io/kube-scheduler
FROM registry.k8s.io/kube-scheduler:v1.35.8
# registry.k8s.io/kube-scheduler
...
# registry.k8s.io/kube-apiserver
FROM registry.k8s.io/kube-apiserver:v1.34.11
# registry.k8s.io/kube-apiserver

# registry.k8s.io/kube-proxy
FROM registry.k8s.io/kube-proxy:v1.34.11
# registry.k8s.io/kube-proxy

# registry.k8s.io/kube-scheduler
FROM registry.k8s.io/kube-scheduler:v1.34.11
# registry.k8s.io/kube-scheduler
...
# registry.k8s.io/kube-apiserver
FROM registry.k8s.io/kube-apiserver:v1.33.13
# registry.k8s.io/kube-apiserver
...
# registry.k8s.io/kube-scheduler
FROM registry.k8s.io/kube-scheduler:v1.33.13
# registry.k8s.io/kube-scheduler
...
# registry.k8s.io/kube-apiserver
FROM registry.k8s.io/kube-apiserver:v1.33.12
# registry.k8s.io/kube-apiserver
...
# registry.k8s.io/kube-scheduler
FROM registry.k8s.io/kube-scheduler:v1.33.12
# registry.k8s.io/kube-scheduler
...
# calico/typha
FROM calico/typha:v3.32.2
# calico/typha

# calico/ctl
FROM calico/ctl:v3.32.2
# calico/ctl
...
# calico/apiserver
FROM calico/apiserver:v3.32.2
# calico/apiserver

# calico/kube-controllers
FROM calico/kube-controllers:v3.32.2
# calico/kube-controllers

# calico/dikastes
FROM calico/dikastes:v3.32.2
# calico/dikastes

# calico/pod2daemon-flexvol
FROM calico/pod2daemon-flexvol:v3.32.2
# calico/pod2daemon-flexvol

# calico/node-driver-registrar
FROM calico/node-driver-registrar:v3.32.2
# calico/node-driver-registrar

# calico/csi
FROM calico/csi:v3.32.2
# calico/csi
...
FROM registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.18.0
# registry.k8s.io/sig-storage/csi-node-driver-registrar

# registry.k8s.io/sig-storage/csi-attacher
FROM registry.k8s.io/sig-storage/csi-attacher:v4.13.0
# registry.k8s.io/sig-storage/csi-attacher
...
FROM registry.k8s.io/sig-storage/csi-snapshotter:v8.6.0
# registry.k8s.io/sig-storage/csi-snapshotter
...
FROM quay.io/strimzi/operator:1.2.0
# quay.io/strimzi/operator
...
FROM confluentinc/cp-enterprise-replicator:8.3.2
# confluentinc/cp-enterprise-replicator

# confluentinc/cp-kafka-rest
FROM confluentinc/cp-kafka-rest:8.3.2
# confluentinc/cp-kafka-rest

# confluentinc/cp-ksqldb-server
FROM confluentinc/cp-ksqldb-server:8.3.2
# confluentinc/cp-ksqldb-server

# confluentinc/cp-schema-registry
FROM confluentinc/cp-schema-registry:8.3.2
# confluentinc/cp-schema-registry
...
# prefecthq/prefect
FROM prefecthq/prefect:3.8.7.dev3-python3.14
# prefecthq/prefect
...
FROM poweradmin/poweradmin:4.4.1
# poweradmin/poweradmin
...
FROM cr.noroutine.me/catalyst/tls-leech:v0.1.2
# cr.noroutine.me/catalyst/tls-leech
