...
FROM squidfunk/mkdocs-material:8.2.3
# squidfunk/mkdocs-material
...
FROM haproxytech/haproxy-debian:2.5.4
# haproxytech/haproxy-debian
# minio/minio
...
FROM gitlab/gitlab-runner:alpine-v14.8.1
# gitlab/gitlab-runner
# gitlab/gitlab-ce
...
# plausible/analytics
# verdaccio/verdaccio
FROM verdaccio/verdaccio:5.6.2
# verdaccio/verdaccio
# strapi/strapi
...
FROM bitnami/prometheus-operator:0.54.1-debian-10-r1
# bitnami/prometheus-operator
...
# bitnami/nginx
# bitnami/minio
FROM bitnami/minio:2022.2.26-debian-10-r0
# bitnami/minio
# bitnami/minio-client
FROM bitnami/minio-client:2022.2.26-debian-10-r0
# bitnami/minio-client
...
# paulbouwer/hello-kubernetes
# stakater/reloader
FROM stakater/reloader:v0.0.108
# stakater/reloader
# registry
FROM registry:2.8.0
# registry
