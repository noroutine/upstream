...
# gitlab/gitlab-runner
# gitlab/gitlab-ce
FROM gitlab/gitlab-ce:14.9.2-ce.0
# gitlab/gitlab-ce
...
# ghost
# bitnami/ghost
FROM bitnami/ghost:4.42.1-debian-10-r0
# bitnami/ghost
# matomo
...
FROM bitnami/prometheus-operator:0.55.1-debian-10-r5
# bitnami/prometheus-operator
...
# bitnami/nginx
# bitnami/minio
FROM bitnami/minio:2022.4.1-debian-10-r0
# bitnami/minio
...
FROM bitnami/kubeapps-dashboard:2.4.4-debian-10-r0
# bitnami/kubeapps-dashboard
...
FROM bitnami/kubeapps-pinniped-proxy:2.4.4-debian-10-r7
# bitnami/kubeapps-pinniped-proxy
# minio/console
FROM minio/console:v0.15.9
# minio/console
# kutt/kutt
