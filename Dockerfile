...
FROM squidfunk/mkdocs-material:8.1.2
# squidfunk/mkdocs-material
...
FROM yandex/clickhouse-server:21.12.2.17-alpine
# yandex/clickhouse-server
...
# ghost
# bitnami/ghost
FROM bitnami/ghost:4.24.0-debian-10-r9
# bitnami/ghost
# matomo
...
FROM jupyter/datascience-notebook:hub-2.0.0
# jupyter/datascience-notebook
# rocker/shiny
...
FROM bitnami/minio-client:2021.12.10-debian-10-r3
# bitnami/minio-client
...
FROM gcr.io/cloud-provider-vsphere/cpi/release/manager:v1.22.3
