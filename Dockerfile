...
# tigera/operator
FROM quay.io/tigera/operator:v1.40.0
# tigera/operator

# calico/typha
FROM calico/typha:v3.31.0
# calico/typha

# calico/ctl
FROM calico/ctl:v3.31.0
# calico/ctl

# calico/node
FROM calico/node:v3.31.0
# calico/node

# calico/cni
FROM calico/cni:v3.31.0
# calico/cni
...
FROM calico/kube-controllers:v3.31.0
# calico/kube-controllers

# calico/dikastes
FROM calico/dikastes:v3.31.0
# calico/dikastes

# calico/pod2daemon-flexvol
FROM calico/pod2daemon-flexvol:v3.31.0
# calico/pod2daemon-flexvol

# calico/node-driver-registrar
FROM calico/node-driver-registrar:v3.31.0
# calico/node-driver-registrar
...
# prefecthq/prefect
FROM prefecthq/prefect:3.4.26.dev1-python3.13
# prefecthq/prefect

# prefecthq/prefect
FROM prefecthq/prefect:3.4.26.dev1-python3.13-kubernetes
# prefecthq/prefect
