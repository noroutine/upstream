...
FROM yandex/clickhouse-server:21.8.3.44-alpine
...
FROM bitnami/prometheus:2.29.1-debian-10-r5
...
FROM bitnami/minio-client:2021.7.27-debian-10-r20
...
FROM bitnami/grafana:8.1.1-debian-10-r7
...
FROM mattermost/mattermost-team-edition:5.37.1
